                                ...
                                <tbody>
                                   ...
                                   ?>
                                    <tr class="odd gradeX">
                                        ...
                                        <td  class="center al"><a href="delUser.php?uid=<?php echo $id; ?> " onclick="return confirm('bạn có muốn xóa không')" class="btn btn-danger"><i class="fa fa-trash-o  fa-fw"></i> Delete</a></td>
                                        <td class="center al"><a href="editUser.php?uid=<?php echo $id; ?>" class="btn btn-default"><i class="fa fa-pencil fa-fw"></i> Edit</a></td>
